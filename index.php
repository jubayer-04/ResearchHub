                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <p style="color: #666; margin: 0.5rem 0 0 0; font-size: 0.9rem;">
                                    ...
                                    <?php if ($row['year']): ?>
                                        <a href="index.php?search_year=<?php echo $row['year']; ?>" style="color: #2d7ab8; text-decoration: none; margin-left: 0.5rem;">
                                            📅 (<?php echo $row['year']; ?>)
                                        </a>
                                    <?php else: ?>
                                        (N/A)
                                ...
                                <?php if ($row['tags']): ?>
                                    <p style="margin-bottom: 1rem;">
                                        ...
                                        <?php foreach (explode(',', $row['tags']) as $tag): ?>
                                            <a href="index.php?search_tag=<?php echo urlencode(trim($tag)); ?>" class="tag primary" style="text-decoration: none; cursor: pointer;">
