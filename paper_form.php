...
<body>
    ...
    <div class="container">
        <div class="content">
            <a href="index.php" class="btn btn-secondary btn-sm" style="margin-bottom: 1.5rem;">← Back to Papers</a>
            ...
            <?php if ($success): ?>
                <div class="alert alert-success">
                    ...
                    <div>
                        ...
                        <p><a href="index.php">View all papers</a> or <a href="view_paper.php?id=<?php echo $id; ?>">view this paper</a></p>
                    </div>
                </div>
            <?php endif; ?>
